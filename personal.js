function writedata() {
  ...
  curd_data.map((data) => {
    ...
    element += `
      <ul style="color:black; background-color:white; margin-top:10px;margin-left:10px; margin-right:10px;  border-radius:8px;height:40px; list-style: none; display: flex;justify-content: space-evenly; align-items: center; text-align: center; box-shadow: rgba(58, 58, 62, 0.23) 0px 7px 29px 0px;">
